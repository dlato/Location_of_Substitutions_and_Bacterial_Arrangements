...
\begin{table}[H]
	...
	\resizebox{0.8\textwidth}{!}{\begin{minipage}{\textwidth}
			\begin{tabular}{lll}
				...
				Outgroup: \lis EDGe & NC\_003210 & November 11, 2016\\
				\midrule
				\multicolumn{3}{c}{\strep} \\
				\midrule
				\sliv TK24 & NZ\_GG657756 & April 28, 2017\\
				\sliv 1362 & NZ\_CM001889 & April 28, 2017\\
				\scoe A3 * & AL645882 & November 30, 2016\\
				Outgroup: \tub H37Rv & NC\_000962 & November 30, 2016\\	\midrule
...
%			& Coefficient Estimate & $R^2$ & Coefficient Estimate & $R^2$ \\
			\midrule
			\ecol Chromosome & -2.35\e{-10}*** & -2.34\e{-10}* & -2.32\e{-10}* & NS & NS & NS\\
			& (0.037)& (0.053) & (0.091) & (0.113) & (0.171) & (0.032)\\
			\midrule
			\bass Chromosome & -7.96\e{-10}** & NS & NS & NS & NS & NS\\
			& (0.042) & (0.002) & (0.002) & (0.035) & (0.046) & (0.447)\\
			\midrule
			\strep Chromosome &  2.38\e{-11}* & NS & 4.41\e{-11}** & NS & NS & NS\\
			& (0.006)& (0.008) & (0.055) & (0.033) & (0.050) & (0.010)\\
			\midrule
			\smel Chromosome &  -9.26\e{-11}*** & -1.26\e{-10}*** & -1.55\e{-10}*** & -1.50\e{-10}** & -1.05\e{-10}* & NS\\
			& (0.107) & (0.191) & (0.253) &(0.326) & (0.460) & (0.526)\\
			\midrule
			\smel \pa &  NS & NS & NS & NS & NS & NS\\
			& (0.013) & (0.001) & (0.024) & (0.279) & (0.355) & (0.240)\\
			\midrule
			\smel \pb &  NS & NS & NS & NS & NS & NS\\
			& (0.010) & (0.020) & (0.043) & (0.025) & (0.002) & (0.039)\\
			\bottomrule
		\end{tabular}
		
	}%resizebox
	\caption{\label{tab:lin_reg_10kb_subs} WEIGHTED. Linear regression on 10kb sections of the genome with increasing distance from the origin of replication after accounting for bidirectional replication. Weighted columns have the total number of substitutions in each 10kb section of the genome divided by the total number of protein coding sites in the genome. Non-weighted columns are performing a linear regression on the total number of substitutions in each 10kb section of the genome. All results are marked with significance codes as followed: $<$ 0.001 = `***', 0.001 $<$ 0.01 = `**', 0.01 $<$ 0.05 = `*', $>$ 0.05 = `NS'. The $R^2$ value for each coefficient estimate is found below the value in brackets ().}
\end{table}
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lcccccc}
			...
			%			& Coefficient Estimate & $R^2$ & Coefficient Estimate & $R^2$ \\
			\midrule
			\ecol Chromosome & -2.84\e{-4}***& -7.24\e{-4}***  & -1.50\e{-3}*** & -2.96\e{-3}*** & -6.08\e{-3}*** & -1.16\e{-2}*\\
			& (0.356)& (0.380) & (0.458) & (0.395) & (0.675) & (0.523)\\
			\midrule
			\bass Chromosome & -1.73\e{-4}**& -4.24\e{-4}* & NS & NS & NS & NS \\
			& (0.046) & (0.046) & (0.059) & (0.060) & (0.113) & (0.162)\\
			\midrule
			\strep Chromosome &  NS& 2.75\e{-6}** & NS & NS & NS & NS\\
			& (0.001) & (0.028) & (0.022) & (0.006) & (0.044) & (0.033)\\
			\midrule
			\smel Chromosome &  -2.21\e{-5}***& -7.74\e{-5}*** & -1.66\e{-4}*** &-2.70\e{-4}** & -5.57\e{-4}* & NS\\
			& (0.151) & (0.264) & (0.294) & (0.313) & (0.535) & (0.742)\\
			\midrule
			\smel \pa & NS& NS & -4.98\e{-4}* & NS & NS & NS\\
			& (0.035) & (0.062) & (0.217) &(0.295) & (0.408) & (0.957)\\
			\midrule
			\smel \pb &  NS & NS & NS &NS & NS & NS\\
			& (0.011) & (0.018) & (0.032) & (0.196) & (0.389) & (0.527)\\
			\bottomrule
		\end{tabular}
		
	}%resizebox
	\caption{\label{tab:lin_reg_10kb_subs} NON-WEIGHTED. Linear regression on 10kb sections of the genome with increasing distance from the origin of replication after accounting for bidirectional replication. Weighted columns have the total number of substitutions in each 10kb section of the genome divided by the total number of protein coding sites in the genome. Non-weighted columns are performing a linear regression on the total number of substitutions in each 10kb section of the genome. All results are marked with significance codes as followed: $<$ 0.001 = `***', 0.001 $<$ 0.01 = `**', 0.01 $<$ 0.05 = `*', $>$ 0.05 = `NS'. The $R^2$ value for each coefficient estimate is found below the value in brackets ().}
\end{table}
...
\begin{table}[h]
	...
	\resizebox{0.75\textwidth}{!}{%
		\begin{tabular}{lcccc}
			...
			\cmidrule{2-5}
			Bacteria and Replicon &  \multicolumn{2}{c}{Weighted} & \multicolumn{2}{c}{Non-Weighted}\\
			& Coefficient Estimate & $R^2$ & Coefficient Estimate & $R^2$ \\
			\midrule
			\ecol Chromosome & -2.35\e{-10}*** & 0.037 & -2.84\e{-4}***& 0.356  \\
			\bass Chromosome & -7.96\e{-10}**& 0.042 &  -1.73\e{-4}**& 0.046\\
			\strep Chromosome & 2.38\e{-11}*& 0.006 & NS& 0.001 \\
			\smel Chromosome & -9.26\e{-11}*** & 0.107 & -2.21\e{-5}***& 0.151 \\
			\smel pSymA & NS & 0.013 & NS& 0.035 \\
			\smel pSymB & NS & 0.010 & NS & 0.011\\
			\bottomrule
		\end{tabular}
		
	}%resizebox
	\caption{\label{tab:lin_reg_10kb_subs} Linear regression on 10kb sections of the genome with increasing distance from the origin of replication after accounting for bidirectional replication. Weighted columns have the total number of substitutions in each 10kb section of the genome divided by the total number of protein coding sites in the genome. Non-weighted columns are performing a linear regression on the total number of substitutions in each 10kb section of the genome. All results are marked with significance codes as followed: $<$ 0.001 = `***', 0.001 $<$ 0.01 = `**', 0.01 $<$ 0.05 = `*', $>$ 0.05 = `NS'.}
\end{table}
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lcc|cc}
			...
			\midrule
			\ecol Chromosome & 1.47\e{-5}** & 4.91\e{-6}** & 5.97\e{-3} & 5.73\e{-3} \\
			\bass Chromosome & -4.64\e{-6}** & 1.46\e{-5}*** & 3.01\e{-3} & 5.40\e{-3} \\
			\strep Chromosome & NS & 7.48\e{-4}*** & 6.43\e{-4} & 1.95\e{-3} \\
			\smel Chromosome & 8.11\e{-5}** & NS & 9.76\e{-5}  & 6.10\e{-5}\\
			\smel pSymA & NS  & -3.40\e{-5}*** & 9.58\e{-4} & 3.55\e{-3}\\
			\smel pSymB & NS & -5.72\e{-5}*** & 2.05\e{-3} &  1.27\e{-3} \\
			\bottomrule
		\end{tabular}
...
A linear regression to determine how the weighted total number of substitutions per 10Kbp section of the genome changes with genomic position was performed  (Table \ref{tab:lin_reg_10kb_subs}).
All additional linear regression results (Table \ref{tab:lin_reg_10kb_subs}) mirror the results from the logistic regression on presence or absence of substitutions and changes in genomic position (see the Main Paper results section for more information).
...
\begin{table}[h]
	...
	\resizebox{0.75\textwidth}{!}{%
		\begin{tabular}{lcc}
			...
			\midrule
			\ecol Chromosome & -4.09\e{-2}*** & 0.339\\
			\bass Chromosome & -1.93\e{-2}**& 0.044\\
			\strep Chromosome & -1.24\e{-3}*** & 0.069\\
			\smel Chromosome & -7.85\e{-2}*** & 0.438\\
			\smel pSymA & -2.49\e{-2}*  & 0.068\\
			\smel pSymB & NS & 8.08\e{-7}\\
			\bottomrule
		\end{tabular}
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lcccc}
			...
			&  &\dn & \ds & $\omega$ \\
			\midrule
			\ecol Chromosome & 7.13 & 14.33 & 1.19 & 14.33 \\
			\bass Chromosome & 5.33 & 4.09 & 0.09 & 4.09 \\
			\strep Chromosome & 8.71 & 49.66 & 28.52 & 49.65 \\
			\smel Chromosome & 16.20 & 65.58 & 66.72 & 65.58\\
			\smel pSymA & 6.90 & 11.39 & 9.45 & 11.39 \\
			\smel pSymB & 6.06 & 13.01 & 5.16 & 13.01\\
			\bottomrule
		\end{tabular}
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lccc|ccc}
			...
			\ecol Chromosome & NS & NS & NS& 
								3.13\e{-7}* (0.254) & NS& NS\\
			\bass Chromosome & NS & NS &  NS&
								NS & NS& NS \\
			\strep Chromosome & -1.35\e{-7}** (0.449)& NS & NS &
								NS & NS & NS \\
