...
A complete list of these values can be found on \texttt{GitHub} (\url{www.github.com/dlato/Location_of_Substitutions_and_Bacterial_Arrangements}) under the file name ``\texttt{Supplementary\_table\_per\_gene\_dN\_dS\_omega.pdf}''.
