...
A protein alignment for these genes can be found on \texttt{GitHub} (\url{https://github.com/dlato/Spatial_Patterns_of_Substitutions}) under the file name ``\texttt{Bacillus\_high\_substitutions\_gene\_example.txt}''.
