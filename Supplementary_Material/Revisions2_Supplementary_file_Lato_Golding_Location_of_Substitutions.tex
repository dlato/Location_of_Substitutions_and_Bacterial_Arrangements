...
\begin{table}[H]
	...
	\end{tabular}
	\end{minipage} 
	\caption{\label{tab:leave_one_out1test} Logistic regression on the presence or absence of a substitution and distance from the origin of replication. Each strain was systematically removed and the entire analysis was repeated. All results are marked with significance codes as followed: $<$ 0.001 = `***', 0.001 $<$ 0.01 = `**', 0.01 $<$ 0.05 = `*', $>$ 0.05 = `NS'. }
\end{table}
