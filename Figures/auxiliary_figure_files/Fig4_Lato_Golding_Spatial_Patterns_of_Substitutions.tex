...
\begin{figure*}
	...
	\begin{tabularx}{\linewidth}{@{}cXX@{}}
		%
		\begin{tabular}{cc}
			\subfloat[]{\includegraphics[width=0.5\textwidth]{./Graphs/sinoC_weighted_subs_bidirectionality_colour_26Mar20.pdf}} 
			& \subfloat[]{\includegraphics[width=0.5\textwidth]{./Graphs/pSymA_weighted_subs_bidirectionality_colour_26Mar20.pdf}} \\
			\raisebox{\dimexpr-.5\height-1em}{\subfloat[]{\includegraphics[width=0.5\textwidth]{./Graphs/pSymB_weighted_subs_bidirectionality_colour_26Mar20.pdf}}} 
			&
			%		\subfloat[]{\includegraphics[width=0.55\textwidth]{C:/Users/Daniella/Documents/Sinorhizobium2015/Papers/Substitutions_paper/Substitutions_paper/Figs/pSymB_sub_exp_histogram_bidirectionality_colour_12Apr18.pdf}}& 
			\begin{minipage}[]{0.8\columnwidth}%
				%	\caption{The bar graphs show the number of substitutions along the replicons of \smel: chromosome (a), \pa (b), and \pb (c). Distance from the origin of replication is on the x-axis beginning with the origin of replication denoted by position zero on the left, and the terminus indicated on the far right. The y-axis of the graph indicates the total number of substitutions found at each position of the replicons of \smel: chromosome (a), \pa (b), and \pb (c). Each bar represents a section of the genome that spans 10,000 base pairs. Protein coding regions are represented in dark grey and non-protein coding regions are represented in light grey.}\label{sub_graphs2} %
				\caption{The bar graphs show the number of substitutions along the replicons of \smel: chromosome (a), \pa (b), and \pb (c). Distance from the origin of replication is on the x-axis beginning with the origin of replication denoted by position zero on the left, and the terminus indicated on the far right. The y-axis of the graph indicates the number of substitutions per 10,000 base pairs of the replicons of \smel: chromosome (a), \pa (b), and \pb (c). Each bar represents a section of the genome that spans 10Kbp. Outliers are represented by light grey bars.}\label{sub_graphs2} %
